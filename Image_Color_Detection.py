...
img = cv2.imread("/home/utkrisht/Downloads/Color-Detection-master/colorpic.jpg")
imgWidth = img.shape[1] - 40

index = ['color', 'color_name', 'hex', 'R', 'G', 'B']
df = pd.read_csv("/home/utkrisht/Downloads/Color-Detection-master/colors.csv", header=None, names=index)
